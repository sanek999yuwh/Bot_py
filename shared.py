...
- ЗАПРЕЩЕНО использовать #, ##, ###, #### — Telegram их не поддерживает и выводит как мусор!
- Заголовки — только **жирный текст**
- Списки — через • или 1. 2. 3.
- Код — в ```тройных кавычках``` с указанием языка
- Отвечай КРАТКО и по делу. Максимум 800 символов если не просят подробнее.
- Если ответ длинный — спроси "Раскрыть подробнее?" вместо того чтобы писать всё сразу.
"""
...
# ===================== ДОНАТ =====================
DONATE_URL = "https://www.donationalerts.com/r/dustway"  # ЗАМЕНИ НА СВОЮ ССЫЛКУ

THANKS_WORDS = [
    "спасибо", "благодарю", "спс", "сяб", "спасиб", "thanks", "thx",
    "выручил", "помог", "красавчик", "красава", "респект", "уважуха"
]

DONATE_REPLY = (
    "😊 Рад помочь!\n\n"
    "Если хочешь поддержать автора — вот ссылка на донат:\n"
    f"{DONATE_URL}\n\n"
    "Это добровольно, я всё равно буду помогать ❤️"
)
# ===================== ФАКТЫ =====================
_INTERESTS = {
